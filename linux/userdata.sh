...
aws s3 cp ${tfi_lx_userdata_log} "s3://${tfi_s3_bucket}/$${S3_TOP_KEYFIX}/$${S3_KEYFIX}/userdata.log"
aws s3 cp /var/log "s3://${tfi_s3_bucket}/$${S3_TOP_KEYFIX}/$${S3_KEYFIX}/cloud-init/" --recursive --exclude "*" --include "cloud*log"
aws s3 cp /var/log/watchmaker "s3://${tfi_s3_bucket}/$${S3_TOP_KEYFIX}/$${S3_KEYFIX}/watchmaker/" --recursive
